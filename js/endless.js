...
const FIXED_STAGE_REGIONS = {
  ...
  4: [
    ...
    [ // Region 3
      ...
      // Arceus: 1 Pokémon +5 levels, every trait in the game at T1
      { name: 'Arceus',       type: 'Normal',       sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/493.png', ids: [493], levelBonus: 5, allTraits: 1 },
