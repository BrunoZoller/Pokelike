...
const MOVE_POOL = {
  Normal:   { physical: {name:'Body Slam',    power:85,  desc:'Slams the foe with the full weight of the body.'},
              special:  {name:'Hyper Voice',  power:90,  desc:'Emits a piercing cry to strike the foe.'} },
  Fire:     { physical: {name:'Fire Punch',   power:75,  desc:'A fiery punch that may leave the foe burned.'},
              special:  {name:'Flamethrower', power:90,  desc:'A scorching stream of fire engulfs the foe.'} },
  Water:    { physical: {name:'Waterfall',    power:80,  desc:'Charges the foe with tremendous force.'},
              special:  {name:'Surf',         power:90,  desc:'A giant wave crashes over the foe.'} },
  Electric: { physical: {name:'Thunder Punch',power:75,  desc:'An electrified punch that crackles with voltage.'},
              special:  {name:'Thunderbolt',  power:90,  desc:'A strong bolt of lightning strikes the foe.'} },
  Grass:    { physical: {name:'Razor Leaf',   power:65,  desc:'Sharp-edged leaves slice the foe to ribbons.'},
              special:  {name:'Magical Leaf',  power:120, desc:'Launches leaves that never miss the target.'} },
  Ice:      { physical: {name:'Ice Punch',    power:75,  desc:'An ice-cold punch that may freeze the foe.'},
              special:  {name:'Ice Beam',     power:90,  desc:'A frigid ray of ice that may freeze the foe.'} },
  Fighting: { physical: {name:'Close Combat', power:120, desc:'Fights with full power, lowering all defenses.'},
              special:  {name:'Aura Sphere',  power:80,  desc:'Focuses aura energy into a perfect, unavoidable sphere.'} },
  Poison:   { physical: {name:'Poison Jab',   power:80,  desc:'Stabs the foe with a toxic spike.'},
              special:  {name:'Sludge Bomb',  power:90,  desc:'Hurls unsanitary sludge at the foe.'} },
  Ground:   { physical: {name:'Earthquake',   power:100, desc:'A massive quake shakes everything around.'},
              special:  {name:'Earth Power',  power:90,  desc:'The earth erupts with force from directly below.'} },
  Flying:   { physical: {name:'Aerial Ace',   power:60,  desc:'An extremely fast attack that never misses.'},
              special:  {name:'Air Slash',    power:75,  desc:'Slashes with a blade of pressurized air.'} },
  Psychic:  { physical: {name:'Zen Headbutt', power:80,  desc:'Focuses willpower and charges headfirst.'},
              special:  {name:'Psychic',      power:90,  desc:'A powerful psychic force attacks the foe\'s mind.'} },
  Bug:      { physical: {name:'X-Scissor',    power:80,  desc:'Slashes the foe with crossed, scissor-like claws.'},
              special:  {name:'Bug Buzz',     power:90,  desc:'Vibrates wings to generate a damaging buzz.'} },
  Rock:     { physical: {name:'Rock Slide',   power:75,  desc:'Large boulders are hurled at the foe.'},
              special:  {name:'Power Gem',    power:80,  desc:'Attacks with rays of light generated by gems.'} },
  Ghost:    { physical: {name:'Shadow Claw',  power:70,  desc:'Slashes with a wicked claw made of shadows.'},
              special:  {name:'Shadow Ball',  power:80,  desc:'Hurls a blob of dark energy at the foe.'} },
  Dragon:   { physical: {name:'Dragon Claw',  power:80,  desc:'Slashes the foe with razor-sharp dragon claws.'},
...
const USABLE_ITEM_POOL = [
  ...
  { id: 'evo_stone',   name: 'Evolution Stone',   desc: 'Force evolves a Pokémon regardless of level',  icon: '🌟', usable: true },
];
